export const MODEL_CONFIG = {
  routes: {
    bible_generator: process.env.BIBLE_MODEL ?? 'kimi-k2.6',
    saga_planner: process.env.SAGA_PLANNER_MODEL ?? 'kimi-k2.6',
    arc_planner: process.env.ARC_PLANNER_MODEL ?? 'kimi-k2.6',
    packet_generator: process.env.PACKET_MODEL ?? 'kimi-k2.6',
    writer: process.env.WRITER_MODEL ?? 'kimi-k2.6',
    auto_fixer: process.env.FIXER_MODEL ?? 'kimi-k2.6',
    llm_validator: process.env.VALIDATOR_MODEL ?? 'kimi-k2.6',
    canon_extractor: process.env.EXTRACTOR_MODEL ?? 'kimi-k2.6',
    summary_compactor: process.env.COMPACTOR_MODEL ?? 'kimi-k2.6',
    high_stakes_reviewer: process.env.HIGH_STAKES_MODEL ?? 'kimi-k2.6',
  },
  pricing: {
    'kimi-k2.6': { input: 0, cachedInput: 0, output: 0 },
