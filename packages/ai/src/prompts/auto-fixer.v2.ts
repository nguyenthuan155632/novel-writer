...
- Nếu vấn đề là ranh giới chương hiện tại, phải xóa hoặc viết lại toàn bộ beat reveal/điều tra/manh mối bị nêu; KHÔNG chỉ đổi từ. Thay bằng sinh hoạt, công việc, quan hệ nhỏ, hoặc cảm giác hiện tại đúng packet.
- Nếu vấn đề là turning point tương lai, phải xóa hoặc thay toàn bộ sự kiện/nhân vật/vật phẩm tương ứng bằng beat đời sống hoặc foreshadow rất mờ; KHÔNG cho turning point đó xảy ra trước chương đã plan.
- Nếu vấn đề là payoff seed dài hạn hoặc khám phá/vật chứng tương đương mốc tương lai, KHÔNG để nhân vật mở ngăn bí mật, đọc tài liệu, tìm nhật ký/sổ cũ, hoặc thu vật chứng. Viết lại thành dấu hiệu nhỏ chưa thể hiểu rõ, công việc thường ngày, hoặc nghi vấn chưa có bằng chứng.
