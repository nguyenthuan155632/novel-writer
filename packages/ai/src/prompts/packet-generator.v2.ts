...
${buildStoryOptionsBlock({ storyOptions, target: "packet" })}`,
      user: [
        ...
        `MỞ ĐẦU TIỂU THUYẾT DÀI TẬP: nếu đây là các chương đầu và không có <must_include_seeds>, ưu tiên thiết lập nhịp sống bình thường trước biến cố lớn. Conflict có thể là việc thường ngày, quan hệ nhỏ, trách nhiệm nghề nghiệp hoặc bất an rất mơ hồ. Không bắt buộc có manh mối trong từng chương mở đầu.`,
