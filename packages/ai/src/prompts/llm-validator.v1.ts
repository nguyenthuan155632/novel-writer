...
Nhiệm vụ: đánh giá chương "${chapterTitle}" (chương ${chapterNumber}) theo tiêu chí canon-nhất quán, logic cốt truyện, phong cách viết, bám sát kế hoạch arc/saga.
...
4. Bám sát kế hoạch — xem "Expected changes" và "Turning points" trong context:
   - Chương có thực hiện ít nhất 1 mục trong "Expected changes" của arc không?
   - Có TP nào được đánh dấu [trễ tiến độ] mà chương tiếp tục bỏ qua không?
   - Cảnh giới nhân vật có tiến đúng theo "CẢNH GIỚI LỆCH TIẾN ĐỘ" không?
   Nếu chương hoàn toàn filler (không advance bất kỳ TP hoặc expected change nào) → severity=high.
5. Mức độ nghiêm trọng: low (nhỏ), medium (cần sửa), high (block), critical (block + regenerate)
