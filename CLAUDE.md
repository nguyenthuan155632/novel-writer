...
This project is indexed by GitNexus as **novel-writer** (4725 symbols, 7828 relationships, 214 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
